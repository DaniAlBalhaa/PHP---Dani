 ...
 * att teckenkodning är UTF-8 och inte Win-1252/ISO-8859-1
 * @param string $str En UTF-8 kodad sträng
 * @return string Strängen i omänd ordning
 */
 function utf8_strrev($str){
        //Namnet baklänges - se detta som svar magi tills vidare!
